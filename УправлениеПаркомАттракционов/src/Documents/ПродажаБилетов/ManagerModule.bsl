...
Процедура Билет(ТабДок, Ссылка) Экспорт
	...
	Запрос.Текст =
		...
		|	ПродажаБилетов.Услуги.(
		|		Ссылка,
		|		НомерСтроки,
		|		Номенклатура,
		|		Стоимость,
		|		Кличество,
		|		Сумма) КАК Аттракционы
		|ИЗ
...
//	Шапка = Макет.ПолучитьОбласть("Шапка");
	ОбластьУслугиШапка = Макет.ПолучитьОбласть("УслугиТаблЧастьШапка");
	ОбластьУслуги = Макет.ПолучитьОбласть("УслугиТаблЧасть");
